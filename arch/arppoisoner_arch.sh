...
requirements() {
 ...
 # Install xterm first to run the requirements script in a new window
 sudo pacman -S --noconfirm xterm
 sudo xterm -e ./requirements_arch.sh
 ...
 do
    case $opt in
        "Poison")
         ...
         # Launch both poisoning directions in separate windows and background them
